from sqlalchemy import (
    ...
    Text, SmallInteger, ForeignKey, LargeBinary
)
...
class Product(Base):
    ...
    productLine = Column(String(50),    ForeignKey(
        "productlines.productLine"), nullable=False)
...
class Employee(Base):
    ...
    officeCode = Column(String(10),  ForeignKey(
        "offices.officeCode"),         nullable=False)
    reportsTo = Column(Integer,     ForeignKey(
        "employees.employeeNumber"),   nullable=True)
...
class Customer(Base):
    ...
    country = Column(String(50),    nullable=False)
    salesRepEmployeeNumber = Column(Integer,       ForeignKey(
        "employees.employeeNumber"), nullable=True)
...
class Order(Base):
    ...
    customerNumber = Column(Integer,    ForeignKey(
        "customers.customerNumber"), nullable=False)
...
class Payment(Base):
    ...
    customerNumber = Column(Integer,       ForeignKey(
        "customers.customerNumber"), primary_key=True)
...
class OrderDetail(Base):
    ...
    orderNumber = Column(Integer,       ForeignKey(
        "orders.orderNumber"),   primary_key=True)
    productCode = Column(String(15),    ForeignKey(
        "products.productCode"), primary_key=True)

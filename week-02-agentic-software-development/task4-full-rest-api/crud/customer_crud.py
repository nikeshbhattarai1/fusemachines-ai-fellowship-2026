...
def get_customers(db: Session, skip: int = 0, limit: int = 100):
    logger.info(f"DB query: list customers | skip={skip} limit={limit}")
...
def get_customer(db: Session, customer_number: int):
    logger.info(f"DB query: get customer customerNumber={customer_number}")
    customer = (
...
def create_customer(db: Session, customer: CustomerCreate):
    logger.info(f"DB query: create customer name={customer.customerName}")
    ...
    logger.info(
        f"Customer created: customerNumber={db_customer.customerNumber}")
    return db_customer


def update_customer(db: Session, customer_number: int, updates: CustomerUpdate):
    logger.info(f"DB query: update customer customerNumber={customer_number}")
...
def delete_customer(db: Session, customer_number: int):
    logger.info(f"DB query: delete customer customerNumber={customer_number}")
    db_customer = get_customer(db, customer_number)
    if db_customer is None:
        logger.warning(
...
def get_customer_orders(db: Session, customer_number: int):
    logger.info(f"DB query: get orders for customerNumber={customer_number}")
    orders = (
...
def get_customer_payments(db: Session, customer_number: int):
    logger.info(f"DB query: get payments for customerNumber={customer_number}")
    payments = (
